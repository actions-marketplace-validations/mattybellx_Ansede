...
Each pack is a YAML file bundled with the package under src/ansede_static/registry/.

Usage (internal):
    from ansede_static.registry import load_packs_for_source, count_registry_rules
"""
...
from ansede_static.registry.sharded_loader import (
    load_custom_rules_for_code,
    load_rules_for_code,
)
from ansede_static.registry.community import (
